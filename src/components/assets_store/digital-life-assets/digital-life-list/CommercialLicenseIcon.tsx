...
import CommercialStarIcon from "@/icons/assets_store/CommercialStarIcon";

function CommercialLicenseIcon() {
  return (
    <Tooltip color="warning" showArrow={true} size="lg" content="Commercial">
      <Button isIconOnly color="default" variant="light" className="data-[hover=true]:bg-transparent">
