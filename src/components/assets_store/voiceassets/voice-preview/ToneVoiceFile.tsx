...
import { toneListEn, TypeTone } from "@/lib/definitions.tone";
  ...
  return (
    <div
      className={cn([
        ...
        isSelected ? "border-2  border-blue-600 p-[14px]" : "p-4",
        "relative self-stretch bg-zinc-800 rounded-xl justify-start items-center gap-4 inline-flex",
      ])}
    >
