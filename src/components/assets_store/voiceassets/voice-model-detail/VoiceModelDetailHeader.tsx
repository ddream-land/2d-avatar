...
function VoiceAssetDetailHeader({ voicePublishInfo }: { voicePublishInfo: VoiceModelPublishType }) {
  return (
    <div className="w-full h-[82px] flex-col justify-start items-start gap-2.5 flex">
      <div className="self-stretch justify-between items-end inline-flex">
        <div className="justify-center items-center gap-2.5 flex">
          <div className="text-white text-4xl font-semibold leading-10">{voicePublishInfo.publish_info.name}</div>
          <div className="pl-1 pr-2 py-1 bg-black/opacity-30 rounded-[36px] backdrop-blur-[21px] justify-start items-center gap-1.5 flex">
            ...
            <div className="text-white text-sm font-normal leading-tight">GPT-Sovits</div>
          </div>
        </div>
