...
function VoiceAssetDetailRight({ voicePublishInfo }: { voicePublishInfo: VoiceModelPublishType }) {
    ...
    <div className="flex-col justify-start items-start gap-6 inline-flex">
      <div className="self-stretch justify-between items-end inline-flex">
        <div className="w-full shrink-0 self-stretch justify-end items-center gap-2 flex">
          <VoiceModelCollectButton
            like={voicePublishInfo.like}
            publishId={voicePublishInfo.publish_id}
            starNum={voicePublishInfo.star_num}
          />
      ...
      <div className="self-stretch flex-col justify-start items-start flex">
        ...
        <div className="self-stretch h-[68px] py-3 border-t border-white/opacity-10 flex-col justify-center items-start gap-2 flex">
          <div className="self-stretch text-zinc-400 text-xs font-normal leading-none">By</div>
        ...
        <div className="self-stretch h-[68px] py-3 border-t border-white/opacity-10 flex-col justify-center items-start gap-2 flex">
          <div className="self-stretch text-zinc-400 text-xs font-normal leading-none">Time</div>
          <div className="text-white text-sm font-semibold leading-tight">
        ...
        <div className="self-stretch py-3 border-t border-white/opacity-10 flex-col justify-center items-start gap-2 flex">
          <div className="self-stretch text-zinc-400 text-xs font-normal leading-none">Permissions</div>
